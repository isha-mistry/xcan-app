...
const managedPodMemberStatusValues = [
  "active",
  "inactive",
  "pending",
  "removed",
] as const;
const memberApprovalActionValues = [
  "approve",
  "reject",
  "activate",
  "deactivate",
...
export const ProjectStatusUpdateSchema = z
  ...
  .refine(
    (data) => data.status !== undefined || data.isApproved !== undefined,
    {
...
export const MemberManagementSchema = z
  .object({

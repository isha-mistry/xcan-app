...
const ProposalMainStatusSkeletonLoader = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-full relative p-8 rounded-[1rem]">
      {/* Title skeleton */}
      <div className="bg-blue-shade-300 animate-pulse h-8 w-48 rounded-full mb-8"></div>

      <div className="relative w-64 h-64 mb-8">
        {/* Background circle skeleton */}
        <div className="absolute inset-0 rounded-full bg-blue-shade-300 animate-pulse opacity-50"></div>

        {/* Main circle skeleton */}
        <div className="absolute inset-0 border-4 border-blue-shade-300 animate-pulse rounded-full"></div>
          ...
          return (
            ...
            >
              ...
              <div className="relative">
                <div className="flex items-center justify-center w-12 h-12 rounded-full bg-blue-shade-300 animate-pulse shadow-md"></div>
              </div>
            </div>
          );
        })}

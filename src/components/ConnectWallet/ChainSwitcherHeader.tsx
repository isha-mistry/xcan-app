    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent className="animate-slide-down w-[194px] bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg shadow-xl p-4 ">
        <div className="mb-4 pb-2 border-b border-blue-200">
          <h3 className="text-sm font-semibold text-blue-800 mb-1">Connected as:</h3>
          <div className="flex items-center space-x-2">
            <Wallet size={16} className="text-blue-600" />
            <span className="text-sm text-gray-700">{getSlicedAddress(address)}</span>
            <Copy
              size={14}
        ...
        <div className="mb-4 pb-2 border-b border-blue-200">
          <h3 className="text-sm font-semibold text-blue-800 mb-2">Switch Network:</h3>

...
const WatchCollectibleInfo = ({
  ...
  return (
    <div className="rounded-3xl border border-black-shade-200 font-robotoMono w-full">
      ...
      <div className="flex xl:gap-x-20 gap-x-14 1.7xl:text-sm text-xs h-[calc(100%-48px)] items-center">

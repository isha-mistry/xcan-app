...
const FeedbackTile = () => {
  ...
  return (
    <div className="bg-yellow-200 border-b border-yellow-300 bg-opacity-80 hidden lg:flex justify-between items-center px-4 py-2 font-tektur text-sm text-yellow-800 relative z-[1] shadow-sm">

      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-end mb-12 gap-6">
          ...
          <motion.button
            ...
            className="flex items-center gap-3 bg-white/5 backdrop-blur-2xl border border-white/10 px-6 py-2.5 rounded-full text-white font-black hover:bg-white/10 hover:border-blue-400/20 transition-all duration-300 group shadow-lg"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {modules.map((module, index) => (
            <motion.div
              ...
              className={`group relative bg-white/[0.01] backdrop-blur-3xl border ${module.isFree ? "border-dashed border-white/10" : "border-white/5"
                } rounded-[32px] p-8 hover:bg-white/[0.03] hover:border-blue-500/10 transition-all duration-500 overflow-hidden shadow-xl`}
            >
              {/* Card Inner Glow */}

...
const CapabilityCard = ({ item, index }: { item: typeof capabilities[0]; index: number }) => {
      ...
      <div className="relative z-10 h-full flex flex-col justify-between">
        <div>
          <div className="flex justify-between items-start mb-8">
            <div
              className={`w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center border border-white/10 group-hover:scale-110 group-hover:bg-white/10 transition-all duration-500`}
            >
              {item.icon}
            </div>
          </div>
        ...
        <div className="mb-10 text-center lg:text-left flex flex-col lg:flex-row items-center lg:items-end justify-between gap-6">
          <div className="max-w-2xl">
            ...
            >
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-100 to-blue-400/50">
                one ecosystem
              </span>
            </motion.h2>
          </div>
          ...
          >
            A comprehensive suite of tools built specifically for the next
            generation of Arbitrum developers.
          </motion.p>
        </div>

        ...
        <div className="max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-10 py-6">
            ...
            {isLoading ? (
                ...
                <div className="glass-container rounded-2xl p-12 text-center">
                    <p className="text-sm text-white/30 font-robotoMono">No colleges yet.</p>
                </div>
            ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {colleges.map((college: any, index: number) => (
                        ...
                        >
                            <div className="flex items-start justify-between mb-3">
                                ...
                                <button
                                    ...
                                    className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-[10px] font-bold font-robotoMono transition-all disabled:opacity-30 ${college.status === "active"
                                            ? "bg-red-500/5 hover:bg-red-500/10 text-red-400/60"
                                            : "bg-green-500/5 hover:bg-green-500/10 text-green-400/60"
                                        }`}
                                >
                            ...
                            <div className="flex items-center gap-4 text-[10px] text-white/20 font-robotoMono">

...
export default function ShowcasePage() {
    ...
    return (
        <div className="max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-10 py-6 min-h-[550px]">
            ...
            {isLoading ? (
                ...
                <div className="glass-container rounded-2xl p-12 text-center">
                    ...
                    <p className="text-sm text-white/30 font-robotoMono">No showcases yet</p>
                </div>
            ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        >
                            <div className="flex items-start justify-between mb-4">
                                <div>
                                    ...
                                    <div className="flex items-center gap-1.5 text-[10px] text-white/20 font-robotoMono">
                            ...
                            <div className="flex items-center gap-4 text-[10px] text-white/15 font-robotoMono mb-4">
                                {showcase.eventDate && (

...
export const POD_MEMBER_STATUS = [
  "pending",
  "active",
  "inactive",
  "removed",
] as const;
/** RSVP for Pod Member selection (Yes / No in invite email). */
export const POD_MEMBER_INVITE_STATUS = [
  "pending",
  "accepted",
  "declined",
] as const;
...
export interface IPodMember extends Document {
  ...
  podMemberInviteStatus: (typeof POD_MEMBER_INVITE_STATUS)[number] | null;
  podMemberInviteTokenHash: string | null;
  podMemberInviteExpiresAt: Date | null;
  podMemberInviteRespondedAt: Date | null;
  podMemberInvitedBy: string | null;
  deletedAt: Date | null;
  createdAt: Date;
  updatedAt: Date;
}
...
const PodMemberSchema = new Schema<IPodMember>(
  {
    ...
    podMemberInviteStatus: {
      type: String,
      enum: [...POD_MEMBER_INVITE_STATUS, null],
      default: null,
    },
    podMemberInviteTokenHash: { type: String, default: null, select: false },
    podMemberInviteExpiresAt: { type: Date, default: null },
    podMemberInviteRespondedAt: { type: Date, default: null },
    podMemberInvitedBy: { type: String, default: null, lowercase: true },
...
export const PodMember = (() => {
  ...
  return (
    mongoose.models.PodMember ||
    mongoose.model<IPodMember>("PodMember", PodMemberSchema)
  );
})();
